...
# 질문 1
answer_1 = st.text_input("1. 하이브리드 차 등록 대수를 볼 때, 꺾은선 그래프의 눈금을 어떻게 표기하면 좋을까요? (예: 100,000부터 시작하여 10만 단위 간격으로 표시 등)")

# 질문 2
answer_2 = st.text_input("2. 연도별 등록 대수와 등록 비중이 가장 높은 차종은 어떤 것인가요? (예: 수소 등)")
